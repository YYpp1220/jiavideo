...
public class KaptchaConfig {
    ...
    public DefaultKaptcha getDefaultKaptcha() {
        ...
        return doGetDefaultKaptcha(defaultKaptcha, properties);
    }
...
//        properties.setProperty("kaptcha.border.color", "105,179,90");
     ...
     * 获取默认kaptcha
     *
     * @param defaultKaptcha 默认kaptcha
     * @param properties     属性
     * @return {@link DefaultKaptcha}
     */
    private DefaultKaptcha doGetDefaultKaptcha(DefaultKaptcha defaultKaptcha, Properties properties) {
